                    ...
                    <div className={s.modal__content__block}>
                        <div className={s.modal__content}>
                            ...
                            <form>
                                ...
                                <div className={s.form__field}>
                                    <input className={s.form__input} onChange={handleInputChange} name='fio' type='email'/>
                                ...
                                <div className={s.form__field}>
                                    <input className={s.form__input} onChange={handleInputChange} name='education' type='email'/>
                                    <label className={s.input__label}>Образование *</label>
                                    {inputStates.education && <img src={SUCCESS} className={s.input__success__icon}/>}
                                </div>
                                <div className={s.form__field}>
                                    <input className={s.form__input} onChange={handleInputChange} name='address' type='email'/>
